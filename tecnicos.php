...
<div class="w3-container">
  <h3 style="padding-top: 15px; padding-bottom: 15px;">Técnicos</h3>
  <a href="tec_novo.php"><button type="button" class="btn btn-outline-success">Novo técnico</button></a>
