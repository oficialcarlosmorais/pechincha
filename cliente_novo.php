...
<div class="w3-container">
  <h3 style="padding-top: 15px; padding-bottom: 15px;">Novo cliente</h3>
<form action="comandos.php" method="post">
	...
	<input type="tel" class="form-control" name="telefone" placeholder="Telefone"/><br>
	<input type="tel" class="form-control" name="celular" placeholder="Celular" required /><br>
